...
def main(args):
    ...
    cats = coco_bbox.loadCats(catIds)   # 获取类别具体名称->dict
...
if __name__ == "__main__":
    ...
    parser.add_argument('--coco_image_path', required=False, type=str, default="/data/zsz/models/storage_file/cocodataset/train2014",help="COCO image path.")
    parser.add_argument('--coco_mask_path', default='', type=str, help="COCO mask path, if exists.")
    parser.add_argument('--coco_caption_file', required=False, default='/data/zsz/models/storage_file/cocodataset/annotations/captions_train2014.json', 
                        type=str, help="COCO caption file, default name is 'captions_train2014.json'.")
    parser.add_argument('--coco_instance_file', required=False, type=str, default='/data/zsz/models/storage_file/cocodataset/annotations/instances_train2014.json',
                        help="COCO caption file, default name is 'instances_train2014.json'.")
    parser.add_argument('--output_dir', required=False, type=str, default="/data/zsz/models/storage_file/attention-mask-control/temp",
