...
class DataModuleCustom(LightningDataModule):
    ...
    def add_data_specific_args(parent_args):
        ...
        parser.add_argument('--val_split', default=0, type=float)
        parser.add_argument('--test_split', default=0, type=float)
    ...
    def __init__(
        ...
        print(args.webdataset_base_urls)
        self.webdataset_base_urls = [os.path.join(args.webdataset_base_urls[0], "{}.tar".format(str(i).zfill(5))) for i in range(4142)]
    ...
    def prepare_data(self):
        ...
        all_urls = []
        # print("train_prop", self.train_prop)
