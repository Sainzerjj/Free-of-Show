...
if __name__ == '__main__':
    ...
    # seed_everything(23)
    # /data/zsz/models/storage_file/coco_data/00003.tar
    url = "/data/zsz/ssh/coco_data/{}.tar"
    available_shards = list(range(0, 4000))
    ...
    tokenizer = CLIPTokenizer.from_pretrained("/data/zsz/ssh/models/models--runwayml--stable-diffusion-v1-5/snapshots/1d0c4ebf6ff58a5caecab40fa1406526bca4b5b9/", subfolder="tokenizer")
